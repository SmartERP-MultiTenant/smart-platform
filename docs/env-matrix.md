...
| `NEXT_PUBLIC_SUPPORT_URL`    | empty    | empty    | real support URL when help desk ready (P4.x)           | **build** | [DEF] fallback `''`           | placeholder | Empty = CTA omitted; needs non-empty **build** value (P4.6 args; Help.tsx:17)                                                                                                                    |
