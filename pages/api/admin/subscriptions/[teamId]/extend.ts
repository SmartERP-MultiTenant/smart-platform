...
import { extendSubscriptionSchema } from '@/lib/zod/admin';
import {
...
export default async function handler(
  ...
  try {
    ...
    const logId = await createAdminAuditStart({
      ...
      targetId: tenantId,
      before: beforeState,
      metadata: { newEndDate: body.newEndDate, teamId },
    });
    ...
    try {
      ...
      const message = err.message || 'Failed to extend subscription in ERP';
