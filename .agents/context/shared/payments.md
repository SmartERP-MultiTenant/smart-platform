...
- **Product-level decision** — smart-platform context decision: *swap Stripe for Moyasar/Tabby/Tamara*. The ERP already wires Moyasar plus Tabby/Tamara mocks; productionize by flipping mock→real providers and auditing committed keys (secrets-hygiene risk).
